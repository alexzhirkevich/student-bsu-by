...
import github.alexzhirkevich.studentbsuby.resources.error
...
fun ErrorScreen(
    ...
    error: String,
    updater: Updatable,
    title: String = stringResource(Res.string.something_gone_wrong),
    onMenuClicked: () -> Unit = {}
) {
    Column(
        Modifier
    ...
    val status = WindowInsets.statusBars.getBottom(LocalDensity.current)
